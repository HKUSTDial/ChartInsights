...
- 🧪[Evaluation Scripts on ChartInsights](README.md)
    - [Environment Setup](README.md)
    - [A Quick Start for Overall Evaluations with ChartInsights](README.md)      
    - [Textual Prompt](README.md)
    - [Visual Prompt](README.md)
    - [Vary the Chart Elements](README.md)
    - [Vary the Chart Quality](README.md)
- 📊[Analysis of Evaluation Results with GPT-4o](README.md)
    - [Overall Results Analysis](README.md)
    - [Textual Prompt Results Analysis](README.md)
    - [Visual Prompt Results Analysis](README.md)
    - [Chart Element Results Analysis](README.md)
    - [Chart Quality Results Analysis](README.md) 
...
<div align=center>
<img src="./png/ChartInsights.jpg" width="700px" center>
...
<img src="./png/example_of_chartinsights.png" width="800px" center>
<div align=center>
